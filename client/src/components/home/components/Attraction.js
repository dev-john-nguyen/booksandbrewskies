...
const Attraction = ({ scrollHeight }) => {
  ...
  return (
    <>
      <div className="pt-6 pb-6" id="store" style={{ color: '#fff' }}>
        <div className="row m-auto justify-content-center align-items-center">
          ...
          <div className="col">
            <h1 className="text-center mt-3" style={{ fontSize: '4rem' }}>Follow Us</h1>
            <ul className="list-inline social-button text-center mt-3">
